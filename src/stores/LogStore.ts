...
export const useLogStore = defineStore('log', {
    state: (): { LogMap: LogItem[] } => ({
        ...
        },
        {
            ...
            "date": "2025/12/09",
            "title": "移动端封面适配完成",
            "content": "把封面部分重新组件化了一遍，同时做了响应式适配。现在无论是在电脑还是手机上，封面显示都更自然也更统一。",
            "insight": "😅 歇了一阵子，都把图片加载优化给忘了..."
        },
        {
            "id": 24,
            "date": "2025/12/31",
            "title": "移动端整体阅读体验打磨",
            "content": "这几天主要在反复调整移动端布局，包括文章详情页、侧边栏组件以及卡片间距等问题。踩了不少 Element 栅格和 margin 的坑，但也顺便把移动端的阅读节奏、留白和字号都重新梳理了一遍，现在手机上看文章终于不像是 PC 页面硬缩过来的了。",
            "insight": "🙂 2026 新的一年 新的开始~"
        }
