import{k as p,d as x,x as y,a as P,c as I,e as s,f as n,w as i,g as t,u as o,t as a,h as w,_ as M}from"./index-BnHRuiGr.js";const T=p("list",{state:()=>({ListMap:[{id:0,cover:"cover1.png",title:"我的建站缘由",content:"我一直都想有个自己的网站，在里面我可以记录一些东西，虽然现在它还只是个静态的，但我相信不久以后，它会慢慢变的更好的，就如你我一样。",name:"南下",date:"2025-07-28",tag:"生活随笔",tagId:1,post:`
## 📘  建站缘由
...
> 🚶‍♂️ 人生嘛，就是一步一步走，走到哪算哪。
    ...
    `},{id:3,cover:"cover.png",title:"Vue3 重构大事件后台管理系统总结",content:"最近把之前写的大事件后台管理系统从 Vue2 重构到 Vue3，顺便熟悉了 Pinia、Axios、Element Plus 等技术，并整理了心得体会。",name:"南下",date:"2025-08-20",tag:"前端开发",tagId:2,post:`
\`\`\`txt
...
> 💪 名为生活的大风车啊，我要和你大战三百回合！ 
  ...
  `},{id:5,cover:"cover.png",title:"这次,我想我会成功的~",content:"好久没更新了，总体还行。腿已经完全适应了，虽然上周连着十几天才休息，但也还是撑住了。后来调去了一个相对轻松的岗位，算是个小幸运。只是对比朋友在努力备考学习，自己却总是摆烂，心里难免觉得惭愧。不过，这次我真的想做好，不想再让自己失望了。",name:"南下",date:"2025-09-22",tag:"生活随笔",tagId:1,post:`
\`\`\`txt
只要我想走，路就在脚下~
\`\`\`
# 📖 我会走下去
...
> 🌞 不论刮风还是下雨，太阳照常升起
  ...
  `}]}),actions:{},getters:{listLength:l=>l.ListMap.length,tagLength:l=>new Set(l.ListMap.map(c=>c.tagId)).size}}),z=p("my",{state:()=>({name:"南下",individuality:"一个无趣的人",affiche:"本站正在进行重要的系统升级和优化工作，以改善性能并提供更优质的用户体验。感谢您的理解与支持，升级后将带来更加完善的服务。敬请期待！"})}),C="/assets/name-DO2qTg4S.jpg",k="/assets/weixin-C_KUkzr9.png",A={class:"my"},E={class:"grid-content ep-bg-purple"},L={class:"users"},U={class:"cover"},q={class:"avatar-wrapper"},D={class:"user"},N={style:{"font-size":"24px","font-weight":"700"}},$={class:"count"},B={class:"number"},G={class:"number"},H={class:"grid-content ep-bg-purple",style:{"min-height":"150px"}},O={class:"noticeboard"},R={class:"title"},J={class:"content"},j={class:"grid-content ep-bg-purple",style:{"min-height":"120px"}},F={class:"weixin"},K={class:"search"},Q={class:"bottom"},W=x({__name:"My",setup(l){const r=z(),c=T(),{listLength:m,tagLength:g}=y(c),{name:_,individuality:v,affiche:b}=P(r);return(X,e)=>{const h=n("el-avatar"),d=n("el-col"),f=n("SvgIcon"),u=n("el-icon"),S=n("Search"),V=n("el-row");return w(),I("div",A,[s(V,null,{default:i(()=>[s(d,{span:22},{default:i(()=>[t("div",E,[t("div",L,[t("div",U,[t("div",q,[e[0]||(e[0]=t("span",{class:"breath-ring"},null,-1)),s(h,{size:80,src:o(C),class:"name"},null,8,["src"])])]),t("div",D,[t("span",N,a(o(_)),1),t("span",null,a(o(v)),1),t("div",$,[t("div",null,[e[1]||(e[1]=t("div",{class:"title"}," 文章 ",-1)),t("div",B,a(o(m)),1)]),e[3]||(e[3]=t("div",null,[t("div",{class:"title"}," 评论 "),t("div",{class:"number"}," 0 ")],-1)),t("div",null,[e[2]||(e[2]=t("div",{class:"title"}," 分类 ",-1)),t("div",G,a(o(g)),1)])])])])])]),_:1}),s(d,{span:22},{default:i(()=>[t("div",H,[t("div",O,[t("div",R,[s(u,{size:"22"},{default:i(()=>[s(f,{iconName:"icon-tongzhi"})]),_:1}),e[4]||(e[4]=t("span",null,"公告栏",-1))]),t("div",J,a(o(b)),1)])])]),_:1}),s(d,{span:22},{default:i(()=>[t("div",j,[t("div",F,[e[7]||(e[7]=t("div",{class:"QR"},null,-1)),t("div",K,[e[6]||(e[6]=t("div",{class:"top"},[t("img",{src:k,alt:""}),t("span",null,"微信搜一搜")],-1)),t("div",Q,[t("span",null,[s(u,{size:18,color:"#fff"},{default:i(()=>[s(S)]),_:1})]),e[5]||(e[5]=t("span",null,"南下",-1))])])])])]),_:1})]),_:1})])}}}),Z=M(W,[["__scopeId","data-v-6969e9e1"]]);export{Z as M,C as n,T as u};
